...
class MeshItem {
  ...
  render(velocity = 0, mouseCoordinates, selectMesh) {
    ...
    this.uniforms.u_mouse.value.x = lerp(
      this.uniforms.u_mouse.value.x,
      0.0,
      0.0
    );
    this.uniforms.u_mouse.value.y = lerp(
...
class Sketch {
  constructor() {
    this.canvas = document.querySelector(".works-canvas");

    this.images = [...document.querySelectorAll(".work-item__cover-img")];
